...
public class SHA3 
{
    ...
    public static String getSHA_String() {
		return SHA_String;
	}

	public static void setSHA_String(String SHA_String) {
		SHA3.SHA_String = SHA_String;
	}
	
	int count=0;
    int x=0, y=0;
    int i=0;
    private static String SHA_String;
    
    public SHA3(String text) throws Exception {
        ...
        System.out.println("암호화된 코드(SHA3 256bit) : "+hex_out);
        SHA_String = hex_out;
    }
