...
public class MyAdd_License extends JFrame {
	...
	public MyAdd_License() {
		...
		JLabel titleLabel = new JLabel("면허증 추가");
		...
		JLabel 직함 = new JLabel("면허증 종류 ");
		직함.setBounds(10, 10, 200, 30);
		직함.setFont(new Font("", Font.PLAIN, 25));
		panel1.add(직함);

		제목 = new JTextField("이곳에 면허증 종류를 적어주세요.");
		...
		JLabel memo_write2=new JLabel("면허증 카드를 저장할수 있습니다.");
