...
public class MyAdd_Camera extends JFrame {
	...
	public MyAdd_Camera() {
		...
		JLabel titleLabel = new JLabel("비밀 사진 추가");
		...
		JLabel memo_write2=new JLabel("사진을 저장할 수 있습니다.");
		memo_write2.setBounds(10,150,300,30);
